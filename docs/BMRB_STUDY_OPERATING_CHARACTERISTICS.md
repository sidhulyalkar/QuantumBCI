...
v1 freezes eight software scenarios. Their replication minima are scenario-specific test
fixtures, not universal biological thresholds.

| Scenario | Study truths | Intended interpretation |
| --- | --- | --- |
| `homogeneous-positive-3` | positive, positive, positive | broad positive with no redundant replication margin |
| `homogeneous-null-3` | null, null, null | broad null |
| `homogeneous-positive-4` | positive ×4 | redundant broad positive |
| `homogeneous-null-4` | null ×4 | broad null |
...
| `fragile-one-conflict-4` | positive, positive, positive, reversal | broad pass can coexist with a heterogeneity warning |
| `redundant-positive-4` | positive ×4 | positive control with replication margin |
...
Development and evaluation use distant offsets and have different fingerprints.
...
on declared broad positives. `qualification_defined` remains **false**. v1 does not invent
a pass/fail acceptance threshold after seeing development curves.
